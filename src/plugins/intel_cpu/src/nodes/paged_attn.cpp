...
void PagedAttention::initSupportedPrimitiveDescriptors() {
    ...
    CPU_NODE_ASSERT(orgInputNumber == 13 + extra_input_nums || orgInputNumber == 16 + extra_input_nums,
                    "The input number of PagedAttention should be 13 or 16. but get", orgInputNumber);
    // kvcache, float, []
